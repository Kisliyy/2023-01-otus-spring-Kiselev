...
public class CommentCommandShell implements CommentCommand {
    ...
    public String getComment(@ShellOption(help = "Comment id") String commentId) {
    ...
    public String getCommentsByBook(@ShellOption(help = "Book id") String bookId) {
    ...
    public String updateComment(@ShellOption(help = "Comment id") String commentId,
                                @ShellOption(help = "Update text comment") String text) {
